#ifndef SCCONSOLIDATE_HPP_INCLUDED
#define SCCONSOLIDATE_HPP_INCLUDED
#include <iostream>
#include <iomanip>
#include <cmath>
#include <math.h> 
...
void SC_input::Consolidet_SC()
{
  ...
  //--------------------------------------------------------------------------------------------------------------------
  char title0[150];
  sprintf(title0,"../Data/SC/n/nQW/n_%d_%d_%d_%d_%d_%d_%d.dat",ttt0,ttt1,jjt0,jjt1,N,nup,ndown); //| ==== Name | I
  ...
  //--------------------------------------------------------------------------------------------------------------------
  char title1[150];
  sprintf(title1,"../Data/SC/SiSj/SiSjQW/SiSj_%d_%d_%d_%d_%d_%d_%d.dat",ttt0,ttt1,jjt0,jjt1,N,nup,ndown);//| ==== Name | I
  ...
  //--------------------------------------------------------------------------------------------------------------------
  char title2[150];
  sprintf(title2,"../Data/SC/SjSk/SjSkQW/SjSk_%d_%d_%d_%d_%d_%d_%d.dat",ttt0,ttt1,jjt0,jjt1,N,nup,ndown);//| ==== Name | I
  ...
  //--------------------------------------------------------------------------------------------------------------------
  char title3[150];
  bool tut=createDirectory("../Data/SC/Consolidet");
  sprintf(title3,"../Data/SC/Consolidet/Consolidet_%d_%d_%d_%d_%d_%d_%d.dat",ttt0,ttt1,jjt0,jjt1,N,nup,ndown);//| ==== Name | I
